...
export class SignupService {
  ...
  register(auth) {
    this.body = "username="+auth.username+"&password="+auth.password+"&firstname="+auth.firstname+"&lastname="+auth.lastname+"&email="+auth.email+"&applicationid="+this.applicationid;
